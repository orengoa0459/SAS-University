...
/*Condition set to search variable comments for the character string "Good"
and marks a "Y" under variable Yes_No, otherwise marks "N".*/
if findw(Comment,'Good','','i') then Yes_No = 'Y';
	else Yes_No = 'N';
datalines;
