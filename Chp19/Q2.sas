...
/*Displays the main body of the dataset output*/
ods html body = 'Body_College.html'
/*Displays the table of contents in html format*/
contents = 'Contents_Sample.html'
/*Creates the window to display the output*/
frame = 'Frame_Sample.html'
/*Creates the storage path for ods html*/
path = '/folders/myfolders/Chp19';
